...
//Fazendo o espalhamento do vetor para conseguir os parâmetros soltos do vetor
...
//Usar o espalhamento - Segunda tentativa para formar lista corrida
let maisNumeros = [19, 7, 38, ...numeros, 0, -5]
console.log(maisNumeros)

//Usar espalhamento em parâmetros de função (parâmetro de resto)
...
console.log(calcular('+', 15, 19, 12, 32, -7, 6)) //somar
console.log(calcular('*', 15, 19, 12, 32, -7, 6)) //multiplicar
